...
//        return dataset;
//    }
    protected abstract XYDataset createDataset(List<T> sourceData);
...
//                this.title, // заголовок графика
//                this.axisXName, // название оси X
//                this.axisYName, // название оси Y
//                dataset, // серия данных
//                PlotOrientation.VERTICAL, // ориентация графика
//                true, // отображать легенду
//                true, // использовать сглаживание
//                false // использовать подсказки
//        );
